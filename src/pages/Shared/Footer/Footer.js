...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-black text-primary-content mt-10">
                <div>
                    <img src={logo} style={{ height: 90 }} alt="" />
                    <p className="font-bold">
                        Dr. Shihan Mostafizur <br />Providing reliable health care since 1987
                    </p>
                    <p>Copyright © 2022 - All right reserved by Dr. Shihan Mostafizur</p>
                </div>
                <div>
