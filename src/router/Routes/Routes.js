...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: async ({ params }) => fetch(`https://dr-shihan-mostafizur-server-mostafizurhh.vercel.app/services/${params.id}`)
            },
            {
                path: '/addareview/:id',
            ...
            },
            {
                ...
                loader: async ({ params }) => fetch(`https://dr-shihan-mostafizur-server-mostafizurhh.vercel.app/reviews/${params.id}`)
            },
            {
                path: '/addservice',
